...
$MYSQL -h $MYSQL_ADDR -P 3306 -uroot -p$MYSQL_ROOT_PASSWORD -e "${Q1}${Q2}${Q3}"
...
Q4="FLUSH PRIVILEGES;"
$MYSQL -h $MYSQL_ADDR -P 3306 -uroot -p$MYSQL_ROOT_PASSWORD -e "${Q1}${Q2}${Q3}${Q4}"

# Create schema
$MYSQL -h $MYSQL_ADDR -P 3306 -u$MYSQL_USER -p$MYSQL_PASSWORD $MYSQL_DATABASE < $PROJECT_ROOT/app/data/$MYSQL_DATABASE.sql
